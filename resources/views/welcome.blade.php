...
@section('content')
    ...
    <body class="g-sidenav-show  bg-gray-100">
        ...
        <main class="main-content border-radius-lg ">
            ...
            <nav class="navbar navbar-main navbar-expand-lg px-0 mx-4 shadow-none border-radius-xl  blur blur-rounded top-0 z-index-fixed shadow position-absolute"
            ...
            <div class="container-fluid py-4">
                ...
                <h6>If you are not redirected automatically, follow <a
                        href=" https://demos.creative-tim.com/argon-dashboard/pages/dashboard.html ">this link</a>.</h6>
                <div class="row">
